...
export default function S3QuizPage({ params }: { params: Promise<{ id: string }> }) {
  const resolvedParams = use(params);
  const quiz = MetalCardbotS3Quizzes[resolvedParams.id];
