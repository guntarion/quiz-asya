    ...
    <div className='min-h-screen px-4 py-8 md:px-8'>
      ...
      <main className='max-w-6xl mx-auto'>
        <div className='text-center mb-12'>
          <h1 className='text-4xl md:text-6xl font-bold mb-4 text-gradient'>Gacha and Treasures</h1>
          <p className='text-xl md:text-2xl text-[var(--accent1)]'>Discover the secrets!</p>
        </div>
